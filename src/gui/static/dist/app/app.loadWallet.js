            ...
            LoadWalletComponent = (function() {
                ...
                LoadWalletComponent.prototype.loadWalletItem = function(address, inc) {
                    ...
                    this.http.get('/wallet/balance?id=' + address, { headers: headers })
                        ...
                        .subscribe(
                            ...
                            function(err) { return console.log("Error on load balance: " + err); },
                            function() {
                ...
                LoadWalletComponent.prototype.loadProgress = function() {
                    ...
                    this.http.post('/blockchain/progress', '')
                        ...
                        .subscribe(
                            //Response from API
                            function(response) { _this.progress = (parseInt(response.current, 10) + 1) / parseInt(response.highest, 10) * 100; },
                            function(err) { return console.log("Error on load progress: " + err); },
                            function() {
