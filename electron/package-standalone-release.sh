...
# copy binaries
copy_if_exists "${OSX64_OUT}/mzcoin" "$OSX64" "$OSX64_SRC"
copy_if_exists "${WIN64_OUT}/mzcoin.exe" "$WIN64" "$WIN64_SRC"
copy_if_exists "${WIN32_OUT}/mzcoin.exe" "$WIN32" "$WIN32_SRC"
copy_if_exists "${LNX64_OUT}/mzcoin" "$LNX64" "$LNX64_SRC"
copy_if_exists "${LNX_ARM_OUT}/mzcoin" "$LNX_ARM" "$LNX_ARM_SRC"
